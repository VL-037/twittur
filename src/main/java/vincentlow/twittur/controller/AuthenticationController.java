...
public class AuthenticationController extends BaseController {
  ...
  public ResponseEntity<ApiSingleResponse<AuthenticationResponse>> register(@RequestBody CreateAccountRequest request) {
  ...
  public ResponseEntity<ApiSingleResponse<AuthenticationResponse>> refreshToken(HttpServletRequest request) { // to read Header
